document.addEventListener('DOMContentLoaded', () => {
  ...
  for (let i = 0; i < works.length; i += 1) {
    const container01 = `<ul class="container1 containerx"><li><div class="works-pic"><img src="Assets/files/Snapshoot.png" alt=""></div><div class="responsive-image1"><img src="${works[i].workdeskimage}" alt="Responsive Image"></div></li><li><h2 class="works-heading deskheading1">Tonic</h2><div class="canopy canopy1"><div class="canop">CANOPY</div><div class="circle"><i class="fa fa-circle"></i></div>Back End Dev<div class="circle"><i class="fa fa-circle"></i></div>2015</div><p class="works-paragraph deskpar1">${works[i].mobiledescription}</p><ul class="languages languages-1"><li>html</li><li>css</li><li>Javascript</li></ul><button class="project-1">See project</button></li></ul><a href="" class="popup popup-inactive"><div class="popup one-content"><span class="close close1">&times</span><div class="object-details"><h2 class="works-heading popheading">Tonic</h2><div class="canopy popcanopy"><img src="Assets/files/Frame 2.png" alt="Loading"></div><div class="works-pic popupimg1"><img src="Assets/files/Snapshoot.png" alt="Loading"></div><div class="deskpop one"><img src="${works[i].popupimage}" alt=""></div><p class="works-paragraph poparagraph1">${works[i].popupmobiledescription}</p><p class="works-paragraph poparagraph2">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it 1960s. Lorem Ipsum is simply dummy text of the printing and typesetting industry. <br> <br> <br> Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it 1960s with the releorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum han printer took a galley of type and scrambled it 1960s with the releawn printer took a galley of type and scrambled it 1960s.</p><div class="technologies"><ul class="languages poplist desklist"><li>html</li><li>css</li><li>Javascript</li> </ul><ul class="languages lang1"><li>Ruby</li><li>Bootstrap</li></ul></div><div><ul class="live-links"><li><button class="live-link1">See live</button></li><li><button  class="live-link2">See source</button></li>  </ul></div></div></div><div class="overlay"></div></a>`;
    const container02 = `<ul class="container2 containery"><li><div class="works-pic"><img src="Assets/files/Snapshoot2.png" alt=""></div><div class="responsive-image2"><img src="Assets/files/Snapshoot desktop2.jpg" alt="Responsive Image"></div></li><li><h2 class="works-heading deskheading2">${works[i].title}</h2><div class="canopy canopy2 canopyX"><img src="Assets/files/Frame 2.png" alt=""></div><div class="canopyX10"><img src="Assets/files/Frame facebook.jpg" alt=""></div><p class="works-paragraph deskpar2 deskparY">${works[i].mobiledescription}</p><p class="deskpar3">Experimental content creation feature that allows users to add to an existing story over the course of a day without spamming their friends.</p><ul class="languages languages-2"><li>html</li><li class="ruby">Ruby on rails</li><li>css</li><li>Javascript</li></ul><button class="project-2">See project</button></li></ul>`;
    const container03 = `<ul class="container1 containerx"><li><div class="works-pic"><img src="Assets/files/Snapshoot3.png" alt=""></div><div class="responsive-image1"><img src="Assets/files/Snapshoot desktop Portfolio3.jpg" alt="Responsive Image"></div></li><li><h2 class="works-heading tonic">Tonic</h2><h2 class="works-heading facebook">Facebook 360</h2><div class="canopy canopy1 canopyX"><img src="Assets/files/Frame 2.png" alt=""></div><div class="canopyX1 canopy-facebook"><div class="faceB">FACEBOOK</div><div class="circle"><i class="fa fa-circle"></i></div>Back End Dev<div class="circle"><i class="fa fa-circle"></i></div>2015</div></div><p class="works-paragraph deskpar1 deskparY">${works[i].mobiledescription}</p><p class="deskpar4">Exploring the future of media in Facebook's first Virtual Reality app; a place to discover and enjoy 360 photos and videos on Gear VR.</p><ul class="languages languages-1"><li>html</li><li class="ruby">Ruby on rails</li><li>css</li><li>Javascript</li></ul><button class="project-3 project-33">See project</button></li></ul>`;
    const container04 = `<ul class="container2 containery"><li><div class="works-pic"><img src="Assets/files/Snapshoot4.png" alt=""></div><div class="responsive-image2"><img src="Assets/files/Snapshoot desktop4.jpg" alt="Responsive Image"></div></li><li><h2 class="works-heading multi">${works[i].title}</h2><h2 class="works-heading uberheading">Uber Navigation</h2><div class="canopy canopy2 canopyX"><img src="Assets/files/Frame 2.png" alt=""></div><div class="canopyuber"><img src="Assets/files/Frame uber.jpg" alt=""></div><p class="works-paragraph deskpar2 deskparY">${works[i].mobiledescription}</p><p class="deskpar5">A smart assistant to make driving more safe, efficient, and fun by unlocking your most expensive computer: your car.</p><ul class="languages languages-2 languages22"><li>html</li><li class="ruby">Ruby on rails</li><li>css</li><li>Javascript</li></ul><button class="project-4">See project</button></li></ul>`;
